...
>
    ...
    <div
        class="mx-5 mb-6 rounded-lg border border-jacarta-100 p-4 dark:border-jacarta-600"
    >
        <span class="text-sm font-medium tracking-tight dark:text-jacarta-200"
            >Loyalty Points</span
        >
        <div class="flex items-center">
            ...
            >
                <path fill="#F8D6A7" d="M959.8 80.7L420.1 976.3 959.8 731z"
                ></path>
                <path
                    fill="#F8B6A7"
                    d="M959.8 731L420.1 976.3l539.7 319.1zm539.8 245.3L959.8 80.7V731z"
                ></path>
                <path fill="#F897A7" d="M959.8 1295.4l539.8-319.1L959.8 731z"
                ></path>
                <path fill="#F8D6A7" d="M420.1 1078.7l539.7 760.6v-441.7z"
                ></path>
                <path fill="#F8B6A7" d="M959.8 1397.6v441.7l540.1-760.6z"
                ></path>
            </svg>
            <span class="text-lg font-bold text-green">350 Points</span>
        </div>
    </div>
    <a
        href="user"
    ...
    <div class="dropdown">
        ...
        >
            <div class="flex items-center space-x-2">
                ...
                <span
                    class="mt-1 font-display text-sm text-jacarta-700 dark:text-white"
                    >Sweet Level</span
                >
            </div>
        ...
        <div
            class="dropdown-menu z-10 hidden w-full min-w-[200px] whitespace-nowrap rounded-xl bg-white py-4 px-2 text-left shadow-xl dark:bg-jacarta-900"
