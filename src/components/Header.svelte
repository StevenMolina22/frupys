<header
  class="js-page-header fixed top-0 z-20 w-full backdrop-blur transition-colors"
>
          ...
          <li class="js-nav-dropdown group relative">
            ...
            >
              <li>
                ...
                >
                  <span
                    class="font-display text-sm text-jacarta-700 dark:text-white"
                    >Home 1</span
                  >
                </a>
              </li>
              ...
              <li>
                ...
                >
                  <span
                    class="mr-4 font-display text-sm text-jacarta-700 dark:text-white"
                    >NFT Game</span
                  >
                  <span
      ...
      <div class="ml-8 hidden lg:flex xl:ml-12">
        ...
        <div class="js-nav-dropdown group-dropdown relative">
          ...
          >
            ...
            >
              <span
                class="text-sm font-medium tracking-tight dark:text-jacarta-200"
                >Balance</span
              >
